    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="px-4 md:px-6 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="flex gap-4">
              ...
              <button className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-8 py-3 rounded-2xl font-bold transition-all duration-300">
                View Deals
              </button>
            </div>
          </div>
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 font-medium">Selected for you based on your taste</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="min-h-[400px] flex flex-col items-center justify-center text-center p-12 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
            ...
            <p className="text-gray-500 max-w-xs">We couldn't find any products in the "{activeCategory}" category. Try another one!</p>
          </div>
        ) : (
      ...
      <section className="bg-green-600 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Stay in the Loop</h2>
          <p className="text-green-100 mb-8 font-medium">Subscribe to get special offers, free giveaways, and once-in-a-lifetime deals.</p>
