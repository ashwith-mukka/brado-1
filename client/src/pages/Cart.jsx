...
const Cart = () => {
  const { cartItems, removeFromCart, updateQuantity, itemsPrice, totalPrice } =
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      ...
                      <div className="mt-4 flex items-center justify-center sm:justify-start gap-4">
                        <div className="flex items-center bg-gray-100 rounded-xl p-1">
                          <button
                            onClick={() => {
                              // If decrementing would reach 0, remove the item entirely
                              if (item.qty - 1 <= 0) {
                          ...
                          <button
                            onClick={() =>
                              updateQuantity(
                                item.product,
                                Math.min(item.stock || 10, item.qty + 1),
                              )
                            }
                            className="w-8 h-8 flex items-center justify-center text-gray-500 hover:text-green-600 font-bold"
                          >
