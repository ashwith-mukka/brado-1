    ...
    <div className="animate-fadeIn pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {statCards.map((stat, idx) => (
          <div
            key={idx}
            className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 transition-all hover:shadow-xl hover:-translate-y-1"
          >
            <h3 className="text-xs font-bold text-gray-400 mb-2 uppercase tracking-widest">
              {stat.title}
            </h3>
            <p
              className={`text-2xl font-black rounded-2xl inline-block px-4 py-2 ${stat.color}`}
            >
              {stat.value}
            </p>
          </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="text-gray-400 text-center py-12 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-100">
          ...
          <p className="text-xs">
            Advanced order monitoring will be available in the next update.
          </p>
        </div>
      </div>
    </div>
